...
My story behind my animation showcase shows my culture and my friends and family which are the most important things in my life which makes me who I am. The data that I used in my project that is represented in the 2D arrays was for my friends and family one a part of the array was friends and the other was family while for my culture I showed a before and after of what iran looked like which is my ethnicity. 
...
The 2 filters that I used in my anaimations was color shift and saturate. The color shift filter modifys the pixels by changing and adjusting the red, green, and blue values in each pixel, which makes the whole image change color or look tinted. The saturate filter increases the intensity of the colors in each pixel, making them look brighter and more vivid instead of dull or faded.
